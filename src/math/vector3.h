...
struct Vector3 {
  ...
  template<class R>
  static Vector3 Random01(R &r) {
    return Vector3(r.Float01(), r.Float01(), r.Float01());
  }

  template<class R>
  static Vector3 Random(R &r) {
    return Vector3(r.Float(), r.Float(), r.Float());
  }
  ...
  template<class V>
  Vector3(const V &v) : x(v.x), y(v.y), z(v.z) {}
