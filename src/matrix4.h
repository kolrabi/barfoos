...
struct Matrix4 {
  ...
  Vector3 operator*(const Vector3 &v) const {
    ...
    float w[4];
    w[0] = a(0,0) * v.x + a(1,0) * v.y + a(2,0) * v.z + a(3,0);
    w[1] = a(0,1) * v.x + a(1,1) * v.y + a(2,1) * v.z + a(3,1);
    w[2] = a(0,2) * v.x + a(1,2) * v.y + a(2,2) * v.z + a(3,2);
    w[3] = a(0,3) * v.x + a(1,3) * v.y + a(2,3) * v.z + a(3,3);
